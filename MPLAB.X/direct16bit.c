 ...
 ******************************************************************************/
#define ROW_SIZE   (64*2)    // for all pic16f188xx
#define CFG_ADDRESS 0xF80000   // for all pic16f188xx
#define CFG_NUM      12       // number of config words for PIC16F188xx
...
void packRow( uint32_t address, uint8_t *data, uint8_t data_count) {
    ...
    uint32_t new_row = (address & 0xffff00)>>1;
